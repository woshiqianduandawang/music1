<template>
  <div id="banner">
    <div id="BannerCenter">
        <!-- 右按钮 -->
        <div id="btnbox">
            <img id="btn1" class="btn" src="@/assets/img/banner/rigth.png"  @click="clickrigth('timer')" alt="">
        </div>
        <!-- 左按钮 -->
        <div  id="btnbox">
            <img id="btn2" class="btn" src="@/assets/img/banner/left.png" @click="clickleft('timer')" alt="">
        </div>
        <!-- 轮播图大盒子 -->
        <div id="father">
            ...
            <!-- 轮播图下面的药丸按钮 -->
            <ol  id="active">
                <li v-for="(item1, index) in banners" :key="index"
